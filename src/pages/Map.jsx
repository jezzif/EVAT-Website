...
function normaliseOperatorName(name) {
  ...
  if (lower.includes("evie")) return "Evie";
  if (lower.includes("pulse")) return "BP Pulse";
  if (lower.includes("ampcharge")) return "Ampol Ampcharge";
  if (lower.includes("nrma")) return "NRMA";
...
export default function Map() {
  ...
  }, [stations, filters, operatorTypes]);
